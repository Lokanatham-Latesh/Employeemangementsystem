...
public class AddEmployee extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		   if (ae.getSource() == add) {
	            ...
	            String education = (String) cbeducation.getSelectedItem().toString();
	            String designation = tfdesignation.getText().toString();
	            String aadhar = tfaadhar.getText().toString();
	            String empId = lblempId.getText().toString();
